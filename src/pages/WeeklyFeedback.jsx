        ...
        <div className="min-h-screen pt-20 bg-neutral-950">
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="bg-neutral-800/50 border border-neutral-800 rounded-xl p-12 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-book-open h-16 w-16 text-neutral-500 mx-auto mb-4" aria-hidden="true">
